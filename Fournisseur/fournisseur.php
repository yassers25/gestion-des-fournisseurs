...
if (isset($_SESSION['loggedin_fournisseur'])) {
    include 'navbar_f.php';
}
 ?>
<br><br><br>
    <div class="container">
        <h1 class="animate__animated animate__fadeInDown">Bienvenue dans votre Espace Fournisseur</h1>
        <div class="options">
            <div class="option animate__animated animate__fadeInLeft" id="a1">
                <h2>Remplir le formulaire</h2>
                <br>
                <p>Proposez un produit à livrer à notre entreprise.</p>
                <br>
                <button id="btnFormulaire">Accéder au formulaire</button>
            </div>
    
            <div class="option animate__animated animate__fadeInRight" id="a2">
                <h2>Voir les demandes de l'entreprise</h2>
                <p>Consultez les demandes actuelles de l'entreprise et postulez directement.</p>
